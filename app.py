...
st_autorefresh(interval=40000, key="auto_sync_timer")
...
st.caption(f"Monitorando **{len(LISTA_PLANILHAS)}** planilha(s) configurada(s) — dados lidos da aba **'{NOME_ABA_LOG}'**. *(Atenção: Atualiza automaticamente a cada 40 segundos)*")
